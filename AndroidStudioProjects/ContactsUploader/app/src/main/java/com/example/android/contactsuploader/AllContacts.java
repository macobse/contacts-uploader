...
import static com.example.android.contactsuploader.R.id;
import static com.example.android.contactsuploader.R.layout;
...
public class AllContacts extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView txt =  (TextView) findViewById(id.text1);
    ...
    */
    ...
    private class InsertData extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            LinearLayout btnLinear1 = (LinearLayout)findViewById(id.image_button_2);
            LinearLayout btnLinear2 = (LinearLayout)findViewById(id.image_button_3);
